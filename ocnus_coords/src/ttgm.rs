    ...
    T: Copy + RealField,
{
    ...
    fn transform_ecs_to_ics<CStride: Dim>(
        ...
        let denom = (powi!(omega.cos(), 2) + powi!(delta * omega.sin(), 2)).sqrt();
...
#[cfg(test)]
mod tests {
    use crate::{OcnusCoords, TTGeometry, TTState};
