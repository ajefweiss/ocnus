use bayesfm::{BFEnsblData, BFModel, ModelError, ObsEnsbl, noise::ObsNoise, observables::ObsVec};
    ...
    T: Copy + RealField,
{
    ...
    fn observe_pbs(
        ...
        let q = match Self::transform_external_to_internal::<U1, Const<P>>(
    ...
    fn simulate_rho<NM>(
        &self,
        ensbl: &mut BFEnsblData<T, Self, D, P>,
        obs_ensbl: &mut ObsEnsbl<OC, ObsVec<T, 1>>,
    ...
    where
        ...
        Self: Sync,
    {
        self.simulate_ensbl_par(ensbl, obs_ensbl, &Self::observe_rho, opt_noise)
    }
    ...
    where
        ...
        Self: Sync,
    {
        self.simulate_ensbl_par(ensbl, obs_ensbl, &Self::observe_pbs, opt_noise)
    }
}
