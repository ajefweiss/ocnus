...
use ocnus::{
    fevms::{
        FEVMEnsbl, ForwardEnsembleVectorModel, ModelObserArray, ModelObserVec, OCModel_CC_LFF,
    },
...
fn benchmark_cc_lff(c: &mut Criterion) {
    let model = OCModel_CC_LFF(PUnivariatePDF::new([
    ...
    let mut output = ModelObserArray::new(&sc, ENSEMBLE_SIZE);
    ...
    group
        ...
        .sample_size(100)
        .throughput(Throughput::Elements(ENSEMBLE_SIZE as u64));
